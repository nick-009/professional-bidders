	  ...
	  <nav role="navigation">
	    <div class="navbar-header">
	      ...
	      <div class="header-nav__logo">
	        <a class="header-nav__logo-link navbar-brand" href="index.php" style="padding:0px;">
	       	<!--<?php if($use_icon === '1'): ?>
	       		<i class="fa <?php echo $site_icon; ?>"></i>
	       	<?php endif; ?>  <?php echo escape($title); ?></a> -->
	       	<img src="http://professionalbidders.com/assets/img/logo.png" style="width: 250px;"></a>
	      </div>
	    </div>
